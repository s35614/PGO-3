public class Main {
    public static void main(String[] args) {
        ...
        KlientKawiarni klient = new KlientKawiarni(100, "Julia",
                "Mazur", "j.mazur@mail.pl");
        ...
        System.out.println("Liczba produktów w systemie: " + ProduktMenu.getLiczbaProduktow());

        ProduktMenu kopia = new ProduktMenu("K-01", "Espresso duplikat",
                9.0, "kawa");
